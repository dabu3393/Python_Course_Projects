...
if direction == 'left':
    ...
    if lake == 'wait':
        ...
        if color == 'yellow':
            print('You walk through the door and find yourself on an island. A shark then runs up onto the island, mouth open, ready to eat you. That\'s when instead of eating you, he throws up $100,000,000 worth of gold and dies. You win!')
        elif color == 'blue':
            print('You walk into an elevator shaft and fall 100 floors. Game Over.')
        elif color == 'red':
            print('You walk through the door only to end up in the middle of a puddle. Then out of nowhere, plugged in hairdryers fall from the ceiling, electricuting you to your death. Game Over.')
        else:
